...
We want Strata to be a welcoming, harassment-free project for everyone,
regardless of experience level, background, or identity. We pledge to interact
in ways that keep the community open, respectful, and constructive.

## Our standards

Behavior that helps the community thrive:
...
- Trolling, deliberate intimidation, or sustained disruption of discussions.
...
pull requests, and discussions — and whenever an individual is representing the
...
temporary or permanent ban from the project, for behavior that violates this
Code of Conduct.
