...
const database: ServiceDefinition[] = [
  ...
  },
  {
    ...
    provider: "azure",
    category: "database",
    description: "A fully managed MySQL flexible server with zone resiliency.",
    icon: "🐬",
    scope: "region",
    nativeType: "Microsoft.DBforMySQL/flexibleServers",
    keywords: ["mysql", "flexible server", "database", "relational"],
    configFields: [
      {
        key: "version",
        label: "Version",
  ...
  },
  {
    ...
    provider: "azure",
    category: "database",
    description: "A managed SQL Server instance with near-full engine compatibility in a VNet.",
    icon: "🏦",
    scope: "region",
    nativeType: "Microsoft.Sql/managedInstances",
    keywords: ["sql managed instance", "managed instance", "mi", "mssql", "database"],
    configFields: [
      {
        key: "administratorLogin",
        label: "Admin Login",
      ...
      },
      {
        ...
        default: "GP_Gen5",
        options: [
          { value: "GP_Gen5", label: "General Purpose (Gen5)" },
          { value: "BC_Gen5", label: "Business Critical (Gen5)" },
        ],
      },
