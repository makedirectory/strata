...
same vocabulary the MCP and IaC importers emit, so imported edges render
identically to hand-drawn ones.
...
> will not scale to MCP-sized graphs. See [Roadmap](/docs/architecture/roadmap).
