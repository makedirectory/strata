...
The module is intentionally a **pure, dependency-free transform**: it takes a flat
list of `DiscoveredResource` objects and maps them onto the registry-backed graph
